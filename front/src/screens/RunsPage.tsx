  ...
  const mockData: Run[] = [
    {
      ...
      setId: 'set-0001',
      setVersion: 3,
      inspectionId: 'c1f0b6c2-0001-4000-8000-000000000001',
      groupRunId: 'grun-0001',
    ...
    },
    {
      ...
      setId: 'set-0002',
      setVersion: 1,
      inspectionId: 'c1f0b6c2-0002-4000-8000-000000000002',
      groupRunId: 'grun-0001',
    ...
    },
    {
      ...
      setId: 'set-0003',
      setVersion: 2,
      inspectionId: 'c1f0b6c2-0003-4000-8000-000000000003',
    ...
    },
    {
      ...
      setId: 'set-0004',
      setVersion: 1,
      inspectionId: 'c1f0b6c2-0004-4000-8000-000000000004',
      groupRunId: 'grun-0002',
